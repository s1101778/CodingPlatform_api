...
class UvaCodeTableSeeder extends Seeder
{
    ...
    {
        $sqlFilePath = base_path('resources\\sql\\UvaCode.sql');
        $outputFilePath = base_path('resources\\sql\\updated_data.sql');
        ...
        try {
            ...
            foreach ($matches as $match) {
                ...
                $updatedSqlContent .= sprintf(
                    ...
                    $topic_url,
                    $star,
                    formatValue($codeContent),
                    formatValue($dataInputContent),
                    formatValue($dataOutputContent),
                    formatValue($dataAInputContent),
                    formatValue($dataAOutputContent),
                    formatValue($dataBInputContent),
                    formatValue($dataBOutputContent)
                );
            }
